## Graphite + Carbon + Statsd

An all-in-one image running graphite, carbon-cache and statsd. **Version**: 0.9.12.

This image contains a sensible default configuration of graphite, statsd and
...
easily by running:
    ...
    docker run -p 80 -p 2003 -p 2004 -p 7002 -p 8125/udp -p 8126 -d acaleph/graphite
...
repository](https://github.com/AcalephStorage/dockerfiles/tree/master/graphite).
